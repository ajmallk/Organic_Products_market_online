...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-e8e*_#mza*=m#=l80dr_k(ip@!_mv4c#h)=c8hfrduxw0d)caf')
...
DATABASES = {
    'default': dj_database_url.config(
        default=config('DATABASE_URL', default='postgresql://postgres:673123@localhost:5432/myprojectdb')
    )
}
...
# Session & CSRF Cross-Domain Cookie Configuration (SameSite=None, Secure=True)
